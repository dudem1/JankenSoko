...
onready var time_played_value_label = $GameStats/TimePlayedValueLabel
onready var steps_taken_value_label = $GameStats/StepsTakenHBoxContainer/StepsTakenValueLabel
